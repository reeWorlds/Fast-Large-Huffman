...
Decode each Huffman code with a single table lookup. The table size will be $2^{\mathrm{max\_{huff\_{code\_{len}}}}}$, where `max_huff_code_len` is the length of the longest Huffman code. 
