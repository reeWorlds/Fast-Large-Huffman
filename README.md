...
Decode each Huffman code with a single table lookup. The table size will be $2^{\mathrm{max\_huff\_code\_len}}$, where `max_huff_code_len` is the length of the longest Huffman code. 
